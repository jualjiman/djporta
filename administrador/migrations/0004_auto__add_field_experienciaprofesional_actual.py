...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperienciaProfesional.actual'
        db.add_column(u'administrador_experienciaprofesional', 'actual',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperienciaProfesional.actual'
        db.delete_column(u'administrador_experienciaprofesional', 'actual')
    ...
    models = {
        ...
        u'administrador.mensaje': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
